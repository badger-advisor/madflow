	...
	return (
		<Dialog maxWidth="xs" onClose={handleClose} open={open}>
			...
			<DialogContent style={{ height: '50px' }}>
				<Typography>
					WARNING: All data associated with your account, including saved Flows, will be permanently deleted.
				</Typography>
			</DialogContent>
			<Divider />
			...
			<Stack marginRight="20px" direction="row" spacing={1} alignItems="center" justifyContent="center">
